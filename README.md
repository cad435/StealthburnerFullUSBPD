...
## Before you download:
 ...
 - Update 2025-08-02: I now face a different Problem with the setup. **This does affect NEMA14 (round) Steppers together with TMC2130-Drivers.** Standalone-Driver mode is working. Details see here: https://klipper.discourse.group/t/hunting-down-strange-issue-with-extruder-motor/24010. As mentioned by mykepredko on that forum the transistor for heater switching (Q3) is very close on spec as well as obsolete. It is therefore replaced with a CSD17552Q3A, that is well defined within the 3.3V Gate-Voltage.
